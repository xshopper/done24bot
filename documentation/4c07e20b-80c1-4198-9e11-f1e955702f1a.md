...
5. What will happen: 
5.a. It will open a chrome window

If you run it first time and you never logged in:
5.b. It will open an Instagram page in the first tab, please log in to tinstagram
5.c. It will open a Telegram page in the 2nd tab.

5.d.
Once you logged in it will open the telegram group you specified, take the instagram links one by one and like them
